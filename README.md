...
If you are a software developer, chances are that you have seen your software being used for malicious purposes like ransomware or spyware. KXEC's main goal is to prevent this from happening.

Since KXEC has restrictions on how you are able to use the software, it is not open-source as defined by the OSI (Open Source Initiative). However, your code is required to have its source available. It's also a file-level license, meaning you can put KXEC code into projects with different licenses , **EXCLUDING** the GPL, as it is strictly incompatible.

## Commercial Restrictions

If you use the KXEC license in your code, you are:
...
* **Charge for services:** You may charge for ancillary services like hosting, installation, or technical support.
* **Accept donations:** You may accept voluntary donations or sponsorships, provided they do not unlock exclusive features or access.

## Keeping Your Code Safe

If a user knowingly uses KXEC code for prohibited acts like malware deployment or unauthorized access, they violate the license.
