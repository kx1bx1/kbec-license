...
Technically, **no**. While the source code is available and you are encouraged to modify it, this license includes "field of use" restrictions (it bans commercial sale and unethical use). Therefore, it does not meet the strict definition of "Open Source" set by the Open Source Initiative (OSI). It is best described as **Ethical Source-Available**.

### Do I have to pay to use this?

No. The license is free to use for personal, educational, and non-profit purposes.

### Do I need to use my legal name to use this software?

No. You may use this software, modify it, and redistribute it using a pseudonym, online handle, or organization name, provided you abide by the terms.
...
* **Allowed:** "I am charging you $100/hour to set up this software and $20/month to host it."
* **Not Allowed:** "I am selling you a license to use this software for $500."
* **Requirement:** You must provide the client with the full source code (including your modifications) at no extra charge.

### Can I accept donations?

**Yes.** You may accept voluntary donations (e.g., GitHub Sponsors, Patreon, Ko-fi), provided that donating is not required to download or use the software.

---

## Ethical Restrictions

### What is prohibited by the "Ethical Use" clause?

You cannot use this software to:

* Hack systems you do not own.
* Spread malware, ransomware, or viruses.
...
Only if you **never** distribute the software and **never** run it as a public network service. If it stays strictly on your private laptop for personal use, you do not need to share changes.
...
Your rights to use the software terminate automatically. However, you have **30 days** to fix the issue (e.g., publish your source code or stop selling the software) after being notified. If you fix it within that time, your rights are reinstated.

### How do I report a violation?

Please contact the repository maintainers via the contact information provided in the project repository.
